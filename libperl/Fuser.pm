...
Fuser - Determine which processes have a file open
...
Given the name of a file it will return a list of Fuser::Procinfo
    ...
    foreach my $proc (@procs)
    {
        ...
        foreach my $fd_data (@fds)
        {
            ...
            if ( my @statinfo = stat $fd )
            {
                ...
                {
                   push @procinfo,Fuser::Procinfo->new($proc, $fd_data);
                }
            }
        }
    }
...
package Fuser::Procinfo;

=back

=head2 PER PROCESS METHODS

The fuser() method will return a list of objects of type Fuser::Procinfo
...
A Fuser::FileDescriptor object that has details of the file as
...
sub new
{
   ...
   my $filedes = Fuser::FileDescriptor->new($pid, $fd_no);
...
package Fuser::FileDescriptor;

=head2 Fuser::FileDescriptor

This is returned by the filedes method of the Fuser::Procinfo and
